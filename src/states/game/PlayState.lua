...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['pickupWalk'] = function() return PlayerPickupWalkState(self.player, self.dungeon) end,
        ['pickupIdle'] = function() return PlayerPickupIdleState(self.player, self.dungeon) end
    }
