...
require 'src/states/entity/player/PlayerPickupWalkState'
require 'src/states/entity/player/PlayerPickupIdleState'
...
gFrames = {
    ...
    ['potlift'] = GenerateQuads(gTextures['potlift'], 16, 32),
    ['potwalk'] = GenerateQuads(gTextures['potwalk'], 16, 32)
}
...
gSounds = {
    ...
    ['lift'] = love.audio.newSource('sounds/pickup.wav', 'static')
}